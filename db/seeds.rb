...
user = User.create!  :email => 'stescriney@hotmail.com', :password => 'ste123', :password_confirmation => 'ste123'
user.toggle!(:admin)
user_1 = User.create!  :email => 'custom1@google.com', :password => 'password', :password_confirmation => 'password'
